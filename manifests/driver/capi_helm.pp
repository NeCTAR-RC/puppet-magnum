...
#
class magnum::driver::capi_helm (
  $kubeconfig_file                = $facts['os_service_default'],
  $helm_chart_repo                = $facts['os_service_default'],
  $helm_chart_name                = $facts['os_service_default'],
  $csi_cinder_default_volume_type = $facts['os_service_default'],
  $csi_cinder_reclaim_policy      = $facts['os_service_default'],
) {
  magnum_config {
