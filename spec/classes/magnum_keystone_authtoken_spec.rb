  ...
  shared_examples_for 'magnum authtoken' do
    ...
    context 'with default parameters' do
      it 'configure keystone_authtoken' do
        ...
        is_expected.to contain_magnum_config('keystone_authtoken/service_token_roles').with_value('<SERVICE DEFAULT>')
    ...
    context 'when overriding parameters' do
      ...
      it 'configure keystone_authtoken' do
        is_expected.to contain_magnum_config('keystone_authtoken/www_authenticate_uri').with_value('https://10.0.0.1:9999/')
        ...
        is_expected.to contain_magnum_config('keystone_authtoken/service_token_roles').with_value(params[:service_token_roles])
